...
//       "id": 1,
//       "description": {
//         "en": "Hi, I'm Luke Ellis, a seasoned analytical chemist and full-stack web developer with a keen interest in environmental sustainability. My career is a testament to a dynamic blend of scientific rigour and technological innovation, underscored by a steadfast commitment to environmental advocacy. Use the toggle button on this site to learn more about both aspects of my professional development in the sciences and in coding.",
//         "es": "Soy Luke Ellis, un químico analítico experimentado y desarrollador web full-stack con un gran interés en la sostenibilidad ambiental. Mi carrera es un testimonio de una combinación dinámica de rigor científico e innovación tecnológica, subrayada por un compromiso inquebrantable con la defensa del medio ambiente. Utilice el botón de alternancia en este sitio para obtener más información sobre ambos aspectos de mi desarrollo profesional en las ciencias y en la codificación.",
//         "de": "Ich bin Luke Ellis, ein erfahrener analytischer Chemiker und Full-Stack-Webentwickler mit einem ausgeprägten Interesse an Umweltschutz. Meine Karriere ist ein Beleg für die dynamische Verbindung von wissenschaftlicher Strenge und technologischer Innovation, unterstrichen durch ein standhaftes Engagement für den Umweltschutz. Verwenden Sie die Umschalttaste auf dieser Seite, um mehr über beide Aspekte meiner beruflichen Entwicklung in den Naturwissenschaften und im Codieren zu erfahren.",
//         "pt": "Sou Luke Ellis, um químico analítico experiente e desenvolvedor web full-stack com grande interesse em sustentabilidade ambiental. Minha carreira é um testemunho da mistura dinâmica de rigor científico e inovação tecnológica, ressaltada por um compromisso firme com a advocacia ambiental. Use o botão de alternância neste site para saber mais sobre ambos os aspectos do meu desenvolvimento profissional nas ciências e na codificação."
//       },
...
//       },
//       image: '/images/About/elephant.webp',
//       align: 'right'
//     },
//     {
//       id: 5,
