...
export const scientistResumeTranslations = {
  en: {
    ...
    feedback: [
      {
        content: "Luke is really growing in his role and showing us skills that are at a premium and an enthusiasm that should see him have a great future with us. Last week he met with our Executive Director Toby Willison and spent around 15 minutes showing him some of the tests that we do. Toby was very impressed with Luke, which left me feeling very proud to have him as part of our team.",
    ...
    awards: [
      {
        name: 'Local Recognition Award',
        content: "Thanks for all your extra efforts you put in last summer in Particle Size. We wouldn't have gotten through the workload and all the required changes without your commitment, tenacity, and work ethic. Thanks.",
    ...
    volunteeringEvents: [
      ...
      {
        title: 'Volunteer at Bradford Science Festival 2013',
        period: 'Oct 2013 - Dec 2014',
        location: 'Bradford Science Festival',
        description: 'Assisted with arrangements for the School of Life Sciences at the University and managed Chemistry\'s spectroscopy demonstration, promoting science to the public.'
      },
      {
        title: 'Chemistry Week 2013: Event Organiser',
      ...
      jobs: [
        {
          ...
          role: 'Químico Analítico y Líder de Apoyo de Equipo (Departamento de Metales)',
          responsibilities: [
            'Dirigí el desarrollo y lanzamiento de una nueva plataforma de comercio electrónico, aumentando las transacciones de clientes en un 40%.',
            'Implementé principios de diseño receptivo, haciendo que nuestro sitio web sea completamente accesible en dispositivos móviles y tabletas.',
            'Optimicé el rendimiento del sitio web, logrando una puntuación del 95% en las vitales básicas de la web.'
          ]
        },
        {
          company: 'Agencia del Medio Ambiente',
          period: 'Mayo 2015 — Dic 2018',
          location: 'Leeds, Reino Unido',
          role: 'Asistente Científico',
          responsibilities: [
