<template>
  ...
  const typeWriterEffect = () => {
    clearInterval(typewriterInterval); // Clear interval before starting a new one
    ...
    typewriterInterval = setTimeout(typeWriterEffect, nextTimeout);
  };
  
  // Start the typewriter effect when the component mounts
  typewriterInterval = setTimeout(typeWriterEffect, 0); // Start immediately
